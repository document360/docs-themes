// Country & language selector row (injected after .left-container)
...
// Article page: footer / feedback placement (replace YOUR-ARTICLE-ID-* with your Document360 article UUIDs)
...
window.addEventListener('articleDetailsLoaded', function(event) {
  ...
  if (articleId === "YOUR-ARTICLE-ID-1") {
  ...
  if (articleId === "YOUR-ARTICLE-ID-2") {
    $('.footer').hide();
